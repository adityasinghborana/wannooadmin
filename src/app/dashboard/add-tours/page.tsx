          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-3 gap-4">
                      ...
                      {availableImages
                        ...
                        .map((image, index) => (
                          <div key={index} className="relative">
                            ...
                            />
                            {selectedImages.includes(image.url) && (
                              <span className="absolute top-0 right-0 bg-blue-500 text-white p-1 rounded-full">
                                ✓
                              </span>
                            )}
                          </div>
            ...
            {Object.keys(formData).map((key, i) => {
              ...
              if (key === "duration" || key === "startTime") {
                ...
                ["childAge", "infantAge", "infantCount"].includes(key)
              ) {
                type = "number";
                      ...
                      <div className="mb-4" key={i}>
                        ...
                        {type === "textarea" ? (
                          <textarea
                            name={key}
                            defaultValue={
                              (formData as any)[key as keyof FormData]
                            }
                            onChange={handleChange}
                            className="w-full p-2 border border-gray-300 rounded mt-1 text-black"
                            required
              ...
              return (
                <div className="col-span-3">
                  ...
                  {(formData as any)[key as keyof FormData].map(
                    (option: any, index: any) => (
                      <div
                        key={index}
                        className="accordion-item border border-gray-300 rounded-lg mb-4 shadow-md"
                      >
                        <div className="accordion-header cursor-pointer bg-blue-100 p-4 flex justify-between items-center rounded-t-lg">
                          <h2 className="text-lg font-semibold text-blue-700">
                            Option {index + 1}
                          </h2>
                          <div className="flex items-center justify-between">
                            <span
                              className="text-blue-700 mx-8"
                        ...
                        <div
                          className={`accordion-content transition-max-height duration-300 ease-in-out ${
                            expandedIndex === index
                              ? "max-h-full p-4"
                            ...
                            <div className="col-span-3">
                              ...
                              <Select
                                ...
                                onChange={(selectedDays) =>
                                  handleDaysChange(selectedDays, index)
                                }
                            ...
                            <div className="col-span-3">
                              ...
                              <div className="grid grid-cols-3 gap-4 mt-2">
                                {option.timeSlots?.map(
                                  (timeSlot: any, timeSlotIndex: any) =>
