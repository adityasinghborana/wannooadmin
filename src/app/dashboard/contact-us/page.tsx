...
import { UpdateHomePageData, getContactUsPageData, getHomePageData } from "@/lib/services"
...
const ContactUsPage = () => {
    ...
    return (
        ...
        <div className="bg-white p-8 shadow-md w-full rounded-3xl" style={{ height: 'calc(100vh - 6rem)' }}>
          <h2 className="text-2xl text-black font-bold mb-6 text-center">Contact page data</h2>
                ...
                return (
                  <div className="mb-4" key={key}>
                    ...
                    <input
                      type="text"
                      name={key}
                      defaultValue={contactpagedata[key as keyof typeof contactpagedata]}
